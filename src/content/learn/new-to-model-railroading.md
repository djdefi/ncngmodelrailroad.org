...
description: A friendly introduction to model railroading and the Nevada County Narrow Gauge, with plain explanations of the terms you will hear.
order: 1
...
- [The trains](/trains): the locomotives and history of the N.C.N.G.
- [About the layout](/about): how our model came to be
- [Plan a visit](/events): when we are open
